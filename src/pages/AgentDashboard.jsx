        ...
        <main className="flex-1 overflow-y-auto p-4 pb-24 md:p-6 custom-scrollbar">
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className={`flex items-center gap-1.5 px-4 py-2 rounded-lg font-bold transition-all shadow-md text-[10px] ${activeTab === "create"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-bold transition-all text-[10px] ${activeTab === "leads"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-bold transition-all text-[10px] ${activeTab === "create"
                ? "bg-orange-600 text-white shadow-md shadow-orange-100"
                : "bg-white text-gray-600 hover:bg-gray-50 shadow-sm border border-gray-100"
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-bold transition-all text-[10px] ${activeTab === "profile"
                ? "bg-orange-600 text-white shadow-md shadow-orange-100"
                : "bg-white text-gray-600 hover:bg-gray-50 shadow-sm border border-gray-100"
                }`}
            >
                ...
                <div className="space-y-6">
                  ...
                  {form.status === "LOST" && (
                    <div className="space-y-1 animate-in fade-in slide-in-from-top-2 duration-300">
                      <label className="text-xs font-bold text-red-600 uppercase">Reason for Lost *</label>
                      <textarea
                        value={form.lostReason}
                        onChange={(e) => setForm({ ...form, lostReason: e.target.value })}
                        placeholder="Why was this lead lost?"
                        rows={2}
                        className="w-full p-3 bg-red-50 border-2 border-red-100 rounded-xl focus:border-red-500 focus:bg-white outline-none transition-all resize-none text-red-900 placeholder:text-red-300 text-sm"
                      />
                    </div>
                  )}
                </div>
